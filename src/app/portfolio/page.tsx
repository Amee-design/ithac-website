        ...
        <section className="relative py-24 bg-primary overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10 text-center">
            ...
            <p className="text-xl text-on-primary-container opacity-80 max-w-2xl mx-auto leading-relaxed">
              At ITHAC, impact is not just an activity. It is a transformation
              that can be tracked, measured, and sustained across individuals,
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={idx}
                  className="text-center p-8 bg-surface-container-low rounded-3xl border border-outline-variant/10"
                >
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-on-surface-variant max-w-2xl mx-auto">
                Moments of transformation across Africa.
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                <div
                  key={i}
                  className="aspect-square rounded-2xl bg-surface-container-low overflow-hidden group"
                >
                  <img
        ...
        <section className="py-24 bg-primary text-on-primary text-center">
          <div className="max-w-3xl mx-auto px-8">
            <h2 className="text-4xl font-black mb-8 leading-tight">
              Ready to be part of the next transformation?
            </h2>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/collaboration"
                className="bg-secondary text-on-secondary px-12 py-5 rounded-2xl font-black text-xl hover:bg-secondary-container transition-all active:scale-95 shadow-xl text-center inline-block"
              >
                Partner with us
              </Link>
              <Link
                ...
                className="bg-white/10 border border-white/20 text-white px-12 py-5 rounded-2xl font-black text-xl hover:bg-white/20 transition-all active:scale-95 text-center inline-block"
              >
                Join the Community
              </Link>
            </div>
